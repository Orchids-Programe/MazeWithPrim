...
//		add(playLbl);
	...
	private void setIcons() {
		generateMazeIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\generate_maze.jpg");
		generateMazeHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\generate_maze.png");
		solveMazeIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\solve_maze.jpg");
		solveMazeHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\solve_maze.png");
		loopIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\loop.jpg");
		loopHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\loop.png");
		resetIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\reset.jpg");
		resetHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\reset.png");
//		playIcon = new ImageIcon("/Image/plays.jpg");
//		playHoverIcon = new ImageIcon("/Image/plays.png");
		generationAlgorithmIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\generation_algorithm.png");
		primsIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\prims.png");
		arrowLeftIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_left.png");
		arrowLeftHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_left_hover.png");
		arrowRightIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_right.png");
		arrowRightHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_right_hover.png");
		arrowUpIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_up.png");
		arrowUpHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_up_hover.png");
		arrowDownIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_down.png");
		arrowDownHoverIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\arrow_down_hover.png");
		cellWidthIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\cell_width.png");
		quickGenIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\quick_gen.png");
		quickSolveIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\quick_solve.png");
		checkboxYesIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\checkbox_yes.png");
		checkboxNoIcon = new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\checkbox_no.png");
		
		for(int i = 2; i < 34; i++) {
			String iconPath ="E:\\Java Code\\MazeWithPrim\\src\\Maze\\bin\\Image\\"+ i + "i.png";
...
//		
	...
	private void showHelp() {
		if (frameHelp == null) {
			frameHelp = new HelpAndAbout(0, "Maze - Help");
			frameHelp.setIconImage(new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\icon.jpg").getImage());
		}
	...
	private void showAbout() {
		if (frameAbout == null) {
			frameAbout = new HelpAndAbout(1, "Maze - About");
			frameAbout.setIconImage(new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\icon.jpg").getImage());
		}
	...
	public  void frame() {
		...
		frame.setIconImage(new ImageIcon("E:\\Java Code\\MazeWithPrim\\src\\Maze\\icon.jpg").getImage());
